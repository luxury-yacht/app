...
var contractTypes = []typeSpec{
	...
	{name: "NamespaceApplicationSummary", typeOf: typeOf[snapshot.NamespaceApplicationSummary]()},
	{name: "NamespaceApplicationsSnapshotPayload", typeOf: typeOf[snapshot.NamespaceApplicationsSnapshot]()},
...
var contractEnums = []enumSpec{
	...
	{name: "ApplicationEvidence", typeOf: typeOf[resourcemodel.ApplicationEvidence]()},
	{name: "ApplicationConfidence", typeOf: typeOf[resourcemodel.ApplicationConfidence]()},
