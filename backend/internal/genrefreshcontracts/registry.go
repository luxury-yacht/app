...
var contractEnums = []enumSpec{
	{
		name:   "DrainEventKind",
		typeOf: typeOf[nodemaintenance.DrainEventKind](),
		values: []string{string(nodemaintenance.EventKindInfo), string(nodemaintenance.EventKindPod), string(nodemaintenance.EventKindError)},
	},
	{
		name:   "DrainEventPhase",
		typeOf: typeOf[nodemaintenance.DrainEventPhase](),
		values: []string{
			string(nodemaintenance.DrainPhaseScheduled),
			string(nodemaintenance.DrainPhaseCancelRequested),
			string(nodemaintenance.DrainPhaseCancelled),
			string(nodemaintenance.DrainPhaseCompleted),
			string(nodemaintenance.DrainPhaseCordon),
			string(nodemaintenance.DrainPhaseCordonRetained),
			string(nodemaintenance.DrainPhaseError),
			string(nodemaintenance.DrainPhaseWarning),
			string(nodemaintenance.DrainPhasePlan),
			string(nodemaintenance.DrainPhaseSkipWait),
			string(nodemaintenance.DrainPhaseWait),
			string(nodemaintenance.DrainPhaseWaitComplete),
			string(nodemaintenance.DrainPhaseEvicting),
			string(nodemaintenance.DrainPhaseDeleting),
			string(nodemaintenance.DrainPhaseEvicted),
			string(nodemaintenance.DrainPhaseDeleted),
			string(nodemaintenance.DrainPhaseEvictError),
			string(nodemaintenance.DrainPhaseDeleteError),
		},
	},
	{
		name:   "DrainStatus",
		typeOf: typeOf[nodemaintenance.DrainStatus](),
		values: []string{
			string(nodemaintenance.DrainStatusRunning),
			string(nodemaintenance.DrainStatusCanceling),
			string(nodemaintenance.DrainStatusCancelled),
			string(nodemaintenance.DrainStatusSucceeded),
			string(nodemaintenance.DrainStatusFailed),
		},
	},
	{
		name:   "CatalogItemScope",
		typeOf: typeOf[objectcatalog.Scope](),
		values: []string{string(objectcatalog.ScopeCluster), string(objectcatalog.ScopeNamespace)},
	},
	{
		name:   "ResourceQueryProvider",
		typeOf: typeOf[snapshot.ResourceQueryProvider](),
		values: []string{string(snapshot.ResourceQueryProviderTypedResource), string(snapshot.ResourceQueryProviderCatalog)},
	},
	{
		name:   "ResourceQueryScope",
		typeOf: typeOf[snapshot.ResourceQueryScope](),
		values: []string{string(snapshot.ResourceQueryScopeCluster), string(snapshot.ResourceQueryScopeNamespace), string(snapshot.ResourceQueryScopeAllNamespaces)},
	},
	{
		name:   "ResourceQueryCompleteness",
		typeOf: typeOf[snapshot.ResourceQueryCompleteness](),
		values: []string{string(snapshot.ResourceQueryComplete), string(snapshot.ResourceQueryPartial)},
	},
	{
		name:   "NamespaceScopeStatus",
		typeOf: typeOf[snapshot.NamespaceScopeStatus](),
		values: []string{string(snapshot.NamespaceScopeStatusNotFound), string(snapshot.NamespaceScopeStatusNoAccess)},
	},
	{
		name:   "ResourceQueryAnchorReason",
		typeOf: typeOf[snapshot.ResourceQueryAnchorReason](),
		values: []string{string(snapshot.ResourceQueryAnchorFiltered), string(snapshot.ResourceQueryAnchorNotFound)},
	},
	{
		name:       "ResourceStreamMessageType",
		typeOf:     typeOf[streammux.MessageType](),
		valuesName: "RESOURCE_STREAM_MESSAGE_TYPES",
		values: []string{
			string(streammux.MessageTypeRequest),
			string(streammux.MessageTypeCancel),
			string(streammux.MessageTypeAck),
			string(streammux.MessageTypeError),
			string(streammux.MessageTypeHeartbeat),
			string(streammux.MessageTypeReset),
			string(streammux.MessageTypeComplete),
			string(streammux.MessageTypeAdded),
			string(streammux.MessageTypeModified),
			string(streammux.MessageTypeDeleted),
		},
	},
	{
		name:       "ResourceStreamSource",
		typeOf:     typeOf[streammux.Source](),
		valuesName: "RESOURCE_STREAM_SOURCES",
		values: []string{
			string(streammux.SourceObject),
			string(streammux.SourceMetric),
			string(streammux.SourceEvent),
			string(streammux.SourceCatalog),
		},
	},
	{
		name:       "ResourceStreamSignal",
		typeOf:     typeOf[streammux.Signal](),
		valuesName: "RESOURCE_STREAM_SIGNALS",
		values: []string{
			string(streammux.SignalChanged),
			string(streammux.SignalReset),
			string(streammux.SignalError),
		},
	},
}
...
var contractDomains = []domainSpec{
	{domain: "namespaces", payload: "NamespaceSnapshotPayload"},
	{domain: "cluster-overview", payload: "ClusterOverviewSnapshotPayload"},
	{domain: "nodes", payload: "ClusterNodeSnapshotPayload"},
	{domain: "object-maintenance", payload: "NodeMaintenanceSnapshotPayload"},
	{domain: "pods", payload: "PodSnapshotPayload"},
	{domain: "object-details", payload: "ObjectDetailsSnapshotPayload"},
	{domain: "object-events", payload: "ObjectEventsSnapshotPayload"},
	{domain: "object-map", payload: "ObjectMapSnapshotPayload"},
	{domain: "object-yaml", payload: "ObjectYAMLSnapshotPayload"},
	{domain: "object-helm-manifest", payload: "ObjectHelmManifestSnapshotPayload"},
	{domain: "object-helm-values", payload: "ObjectHelmValuesSnapshotPayload"},
	{domain: "container-logs", payload: "ContainerLogsSnapshotPayload", frontendOwned: true},
	{domain: "cluster-rbac", payload: "ClusterRBACSnapshotPayload"},
	{domain: "cluster-storage", payload: "ClusterStorageSnapshotPayload"},
	{domain: "cluster-config", payload: "ClusterConfigSnapshotPayload"},
	{domain: "cluster-crds", payload: "ClusterCRDSnapshotPayload"},
	{domain: "cluster-custom", payload: "ClusterCustomSnapshotPayload"},
	{domain: "cluster-events", payload: "ClusterEventsSnapshotPayload"},
	{domain: "catalog", payload: "CatalogSnapshotPayload"},
	{domain: "catalog-diff", payload: "CatalogSnapshotPayload"},
	{domain: "namespace-workloads", payload: "NamespaceWorkloadSnapshotPayload"},
	{domain: "namespace-config", payload: "NamespaceConfigSnapshotPayload"},
	{domain: "namespace-network", payload: "NamespaceNetworkSnapshotPayload"},
	{domain: "namespace-rbac", payload: "NamespaceRBACSnapshotPayload"},
	{domain: "namespace-storage", payload: "NamespaceStorageSnapshotPayload"},
	{domain: "namespace-autoscaling", payload: "NamespaceAutoscalingSnapshotPayload"},
	{domain: "namespace-quotas", payload: "NamespaceQuotasSnapshotPayload"},
	{domain: "namespace-events", payload: "NamespaceEventsSnapshotPayload"},
	{domain: "namespace-custom", payload: "NamespaceCustomSnapshotPayload"},
	{domain: "namespace-helm", payload: "NamespaceHelmSnapshotPayload"},
}
