...
var Bindings = []binding{
	...
	{Name: "Job", Namespaced: true, Service: "workloads.NewJobService(deps)", Import: resourcesPkg + "workloads"},
	...
	{Name: "ReplicaSet", Namespaced: true, Service: "workloads.NewReplicaSetService(deps)", Import: resourcesPkg + "workloads"},
