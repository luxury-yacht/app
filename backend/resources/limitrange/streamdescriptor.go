/*
 * backend/resources/limitrange/streamdescriptor.go
 *
 * LimitRange's resource-stream registry entry.
 */
...
// StreamDescriptor registers LimitRange for resource streaming (namespace-quotas).
var StreamDescriptor = streamspec.Descriptor{
	...
	StreamRow: func(meta streamrows.ClusterMeta, obj metav1.Object) any {
		return BuildStreamSummary(meta, obj.(*corev1.LimitRange))
	},
