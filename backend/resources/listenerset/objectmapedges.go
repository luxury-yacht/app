...
func ObjectMapEdges(clusterID string, obj metav1.Object) []objectmapspec.Edge {
	...
	return []objectmapspec.Edge{{Type: objectmapspec.EdgeUses, TracedBy: "spec.parentRef", Link: resourcemodel.GatewayParentGatewayRefLink(clusterID, listenerSet.Namespace, listenerSet.Spec.ParentRef)}}
}
