...
func (s *Service) Ingress(ctx context.Context, namespace, name string) (*IngressDetails, error) {
	ingress, err := s.deps.KubernetesClient.NetworkingV1().Ingresses(namespace).Get(ctx, name, metav1.GetOptions{})
	if err != nil {
