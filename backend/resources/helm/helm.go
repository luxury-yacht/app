...
// Dependencies captures collaborators required for Helm operations.
...
// Service exposes helpers for inspecting and managing Helm releases.
type Service struct {
	deps Dependencies
}

// NewService constructs a Helm service instance.
