/*
 * backend/resources/httproute/streamdescriptor.go
 *
 * HTTPRoute's resource-stream registry entry (Gateway-API informer factory).
 */
...
// StreamDescriptor registers HTTPRoute for resource streaming (namespace-network).
var StreamDescriptor = streamspec.Descriptor{
	...
	StreamRow: func(meta streamrows.ClusterMeta, obj metav1.Object) any {
		return BuildStreamSummary(meta, obj.(*gatewayv1.HTTPRoute))
	},
