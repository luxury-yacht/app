...
var notifyOnlyStreamDomains = map[string]bool{
	...
	domainNodes:                true,
	domainClusterConfig:        true,
	domainClusterRBAC:          true,
	domainClusterStorage:       true,
	domainClusterCRDs:          true,
	domainNamespaceConfig:      true,
	domainNamespaceRBAC:        true,
	domainNamespaceNetwork:     true,
	domainNamespaceQuotas:      true,
	domainNamespaceStorage:     true,
	domainNamespaceAutoscaling: true,
	domainNamespaceCustom:      true,
	domainClusterCustom:        true,
}
