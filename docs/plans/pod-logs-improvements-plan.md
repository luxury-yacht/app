...
- [ ] Add UI controls for include/exclude/highlight filters appropriate to the object panel
- [ ] Persist include/exclude/highlight filter state for the lifetime of the Object Panel tab, including transient remounts such as cluster switching
- [ ] Drop include/exclude/highlight filter state when the owning Object Panel tab is closed
...
- Pod color stability is explicitly hash-based against the existing 12-color palette; this is a settled design choice, not an open question.
