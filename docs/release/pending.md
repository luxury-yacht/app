...
- Internal type-safety hardening. Cluster lifecycle states, drain status rendering, and object references now use closed types end-to-end, so an invalid state fails at compile time instead of causing a bug at runtime.
