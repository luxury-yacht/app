...
| Refresh, stream, snapshot, diagnostics, or domain changes                  | `.agents/skills/refresh-subsystem/SKILL.md`, `docs/architecture/refresh-system.md`, `docs/architecture/data-layer.md` | `backend/refresh/system`, `backend/refresh/snapshot`, `frontend/src/core/refresh`                         | Domain-specific backend/frontend tests, diagnostics check, `mage qc:prerelease` |
