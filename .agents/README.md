...
| Refresh, stream, snapshot, diagnostics, or domain changes                  | `.agents/skills/refresh-subsystem/SKILL.md`, `docs/architecture/data-freshness.md`, `docs/architecture/refresh-system.md` | `backend/refresh/system`, `backend/refresh/snapshot`, `frontend/src/core/refresh`                         | Domain-specific backend/frontend tests, diagnostics check, `mage qc:prerelease` |
| Resource utilization metrics                                               | `.agents/skills/refresh-subsystem/SKILL.md`, `.agents/skills/object-panel/SKILL.md`, `docs/architecture/resource-metrics.md` | `frontend/src/core/resource-metrics`, metric-bearing snapshot domains, object-panel utilization consumers | Resource-metrics Vitest tests, affected table/panel tests, typecheck, `mage qc:prerelease` |
...
| Object panel details, YAML, actions, or docked panels                      | `.agents/skills/object-panel/SKILL.md`, `docs/frontend/dockable-panels.md`, `docs/frontend/yaml-editor.md` | `frontend/src/modules/object-panel`, `frontend/src/shared/components/yaml`, `backend/resources`, object detail/YAML/action backends | Targeted backend/frontend tests, typecheck, `mage qc:prerelease`                |
...
| Live object age text                                                       | `docs/frontend/live-age.md`, `.agents/skills/browse-tables/SKILL.md`, `.agents/skills/object-panel/SKILL.md`, `.agents/skills/object-map/SKILL.md` | `frontend/src/shared/components/LiveAgeText.tsx`, `frontend/src/shared/hooks/useAgeClock.ts`, age-bearing table/panel/map consumers | Fake-timer Vitest tests, typecheck, `mage qc:prerelease` for non-doc changes    |
