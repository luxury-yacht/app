...
| Refresh execution            | `frontend/src/core/refresh/orchestrator.ts`, `frontend/src/core/refresh/RefreshManager.ts`                         | Orchestrator fetches through per-cluster runtimes; manager schedules.              |
