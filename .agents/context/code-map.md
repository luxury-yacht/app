...
| Area                         | Start Here                                                                                                         | Notes                                                                              |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------- |
| Refresh domain types         | `backend/internal/genrefreshcontracts/registry.go`, generated into `frontend/src/core/refresh/types.generated.ts` | Register backend-owned DTOs and domain payload mappings, then run `go generate ./backend`; keep frontend-only reducer state in `types.ts`. |
