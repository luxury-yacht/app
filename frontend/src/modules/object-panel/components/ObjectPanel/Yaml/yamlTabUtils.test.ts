...
describe('sanitizeYamlForSemanticCompare', () => {
  it('covers sanitizeYamlForSemanticCompare scenarios', async () => {
    {
      // Scenario: ignores generated deployment and client-side apply annotations
      const submitted = `
apiVersion: apps/v1
kind: Deployment
metadata:
...
`.trim();
    ...
    {
      // Scenario: keeps user-authored annotations in semantic comparisons
      const submitted = `
apiVersion: apps/v1
kind: Deployment
metadata:
