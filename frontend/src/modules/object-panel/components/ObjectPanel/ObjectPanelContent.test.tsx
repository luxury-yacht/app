...
describe('ObjectPanelContent', () => {
  ...
  const baseProps: React.ComponentProps<typeof ObjectPanelContent> = {
    ...
    eventsScope: 'cluster-a|team-a:apps/v1:Deployment:api',
    containerLogsScope: 'cluster-a|team-a:apps/v1:deployment:api',
    mapScope: 'cluster-a|team-a:apps/v1:Deployment:api',
