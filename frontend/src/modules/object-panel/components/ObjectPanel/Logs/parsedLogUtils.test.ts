...
describe('parsedLogUtils', () => {
  it('covers parsedLogUtils scenarios', async () => {
    // Scenario: parses non-empty JSON objects and rejects other JSON shapes
    ...
    // Scenario: derives stable sorted field keys
    expect(
      deriveParsedLogFieldKeys([
    ...
    // Scenario: formats parsed values and JSON display lines
    ...
    // Scenario: builds parsed row keys from sequence, line number, or fallback index
