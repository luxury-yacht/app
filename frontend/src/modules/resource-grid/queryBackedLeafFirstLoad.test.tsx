...
describe('query-backed leaf first load', () => {
  ...
  it('covers uses the typed query result on first load for parameterized cases', async () => {
  ...
  it('covers issues a namespace-scoped typed query on first load for parameterized cases', async () => {
    for (const testCase of [
      {
        label: 'namespace config',
        domain: 'namespace-config',
  ...
  it('covers publishes only query-supported sortable keys for parameterized cases', async () => {
    for (const testCase of [
      {
        label: 'namespace config',
