...
describe('buildLocalPartialDataLabel', () => {
  it('covers buildLocalPartialDataLabel scenarios', async () => {
    {
      // Scenario: uses backend warnings when a snapshot producer reports truncation
    ...
    // Scenario: falls back to totals or caller copy when warnings are absent
    expect(
