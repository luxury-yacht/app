...
describe('objectMapG6Behaviors', () => {
  it('covers objectMapG6Behaviors scenarios', async () => {
    {
      // Scenario: disables auto-fit after a canvas drag finishes
    ...
    {
      // Scenario: lets ordinary wheel gestures pan and leaves modifier wheels for zoom
