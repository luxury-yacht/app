...
describe('resourceCalculations utilities', () => {
  it('covers resourceCalculations utilities scenarios', async () => {
    // Scenario: parses cpu strings into millicores
    ...
    // Scenario: parses memory strings into megabytes
    ...
    // Scenario: computes overcommit percentages when limits exceed allocatable
