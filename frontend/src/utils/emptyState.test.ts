...
describe('resolveEmptyStateMessage', () => {
  it('covers resolveEmptyStateMessage scenarios', async () => {
    // Scenario: returns fallback when no error is provided
    ...
    // Scenario: returns fallback for non-permission errors
    ...
    {
      // Scenario: normalizes permission related errors
