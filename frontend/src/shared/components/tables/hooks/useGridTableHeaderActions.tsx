...
interface UseGridTableHeaderActionsOptions<T> {
...
interface GridTableHeaderActions<T> {
  renderSortIndicator: (columnKey: string) => ReactNode;
  handleHeaderClick: (column: GridColumnDefinition<T>) => void;
  handleHeaderContextMenu: (event: ReactMouseEvent, columnKey: string) => void;
...
export function useGridTableHeaderActions<T>({
...
}: UseGridTableHeaderActionsOptions<T>): GridTableHeaderActions<T> {
  ...
  const handleHeaderContextMenu = useCallback(
    (event: ReactMouseEvent, columnKey: string) => {
