...
describe('error recovery strategies', () => {
  it('covers error recovery strategies scenarios', async () => {
    // Scenario: classifies common failure patterns
    ...
    // Scenario: provides user-facing guidance strings
    ...
    // Scenario: indicates which strategies support automatic recovery
    ...
    // Scenario: logs important errors back to the server
