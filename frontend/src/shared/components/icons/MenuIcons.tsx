...
export const CaseSensitiveIcon: React.FC<IconProps> = ({
  ...
  >
    ...
    <path d="M16.2 19c-1.5 0-2.55-.9-2.55-2.2 0-1.35 1.05-2.15 2.95-2.25l1.7-.1v-.45c0-.75-.5-1.15-1.4-1.15-.75 0-1.25.3-1.45.8H13.9c.15-1.3 1.4-2.25 3.15-2.25 1.85 0 3 1 3 2.55V19h-1.5v-.9h-.05c-.45.65-1.25 1-2.2 1zm.45-1.35c1.05 0 1.8-.55 1.8-1.35v-.6l-1.5.1c-1 .05-1.55.4-1.55 1 0 .6.5.85 1.25.85z" />
  </svg>
);
