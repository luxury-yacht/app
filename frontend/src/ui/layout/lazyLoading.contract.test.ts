...
describe('application code-splitting boundaries', () => {
  it('covers application code-splitting boundaries scenarios', async () => {
    {
      // Scenario: loads route and object-panel implementations on demand
      const source = [
    ...
    {
      // Scenario: defers every object-panel tab implementation
      const source = [
    ...
    {
      // Scenario: warms the object-panel shell and default tab together while the app is idle
    ...
    {
      // Scenario: keeps React renderers out of client-side table measurement
