...
describe('permission feature contract', () => {
  it('covers permission feature contract scenarios', async () => {
    {
      // Scenario: uses stable feature keys with labels for every static permission spec
    ...
    // Scenario: keeps cluster capability features in the same keyed catalog
    ...
    {
      // Scenario: maps diagnostics filters to known feature keys
      const filters = [
