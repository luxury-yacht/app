/**
 * frontend/src/core/refresh/fallbacks/containerLogsFallbackManager.test.ts
 *
 * Test suite for containerLogsFallbackManager.
 * Covers key behaviors and edge cases for containerLogsFallbackManager.
 */
...
const setup = async () => {
  ...
  const mod = await import('./containerLogsFallbackManager');
  const manager = mod.containerLogsFallbackManager;
...
describe('containerLogsFallbackManager', () => {
