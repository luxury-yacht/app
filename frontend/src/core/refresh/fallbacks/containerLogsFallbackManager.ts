/**
 * frontend/src/core/refresh/fallbacks/containerLogsFallbackManager.ts
 *
 * Module source for containerLogsFallbackManager.
...
class ContainerLogsFallbackManager {
  ...
  private ensureSubscription(): void {
    ...
    this.unsubscribe = refreshManager.subscribe(SYSTEM_REFRESHERS.containerLogs, async () => {
  ...
  private updateRefresherState(): void {
    ...
    if (hasAuto) {
      refreshManager.enable(SYSTEM_REFRESHERS.containerLogs);
    } else {
      refreshManager.disable(SYSTEM_REFRESHERS.containerLogs);
    }
  }
...
export const containerLogsFallbackManager = new ContainerLogsFallbackManager();
