...
export const CLUSTER_VIEW_DESCRIPTORS = [
  ...
  },
  {
    ...
    keywords: ['browse', 'cluster', 'catalog', 'objects'],
    refresher: 'catalog',
  },
  {
    scope: 'cluster',
    ...
    keywords: ['nodes', 'cluster', 'servers', 'machines'],
  ...
  },
  {
    ...
    keywords: ['events', 'cluster', 'logs', 'history'],
...
export const NAMESPACE_VIEW_DESCRIPTORS = [
  {
    ...
    label: 'Browse',
    intent: 'inventory',
    description: 'Browse catalogued Kubernetes objects in this namespace',
    keywords: ['browse', 'namespace', 'catalog', 'objects'],
    refresher: null,
  },
  {
    scope: 'namespace',
  ...
  },
  {
    ...
    keywords: ['events', 'namespace', 'logs', 'history'],
    refresher: 'events',
  },
  {
    scope: 'namespace',
