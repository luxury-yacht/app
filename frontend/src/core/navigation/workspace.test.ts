...
describe('Global workspace shell isolation', () => {
  it('covers Global workspace shell isolation scenarios', async () => {
    // Scenario: does not project the foreground cluster auth overlay over Global views
    ...
    // Scenario: stages cluster navigation silently until Global is exited
